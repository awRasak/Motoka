  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Registration runs through the FRSC's National Vehicle Identification Scheme (NVIS). You'll need proof of vehicle ownership — the customs duty certificate for an imported vehicle, or the sales receipt or purchase agreement for a new one — plus one accepted form of owner identification. For a company vehicle the natural choice is your CAC/RC number, but a National ID, driver's licence, international passport or Tax Identification Number are each accepted on their own. Head to your nearest FRSC office or state licensing office, fill out the registration form, and make sure every detail matches your supporting documents. Mismatched details are a classic cause of rejected applications, so triple-check spellings, chassis numbers, and dates. Once your plate is issued, verify it through the NVIS portal — worth doing for your own records, and handy if a driver or buyer ever needs proof later.",
        note: "One point worth clearing up: TIN is often described as an extra requirement for commercial vehicles. On the official NVIS form it is one of several accepted identification types, not an addition to them — if you already have a CAC number or National ID, that side is covered. Insurance is captured as a policy number during registration rather than a certificate you hand over, and your address is entered as a form field rather than evidenced with a separate proof-of-address document. Requirements do change, so confirm against nvis.frsc.gov.ng before making the trip.",
      },
      {
      ...
      },
      {
        ...
        body:
          "Here's one people forget: it's not just the vehicle that needs registering — the driver does too. Commercial vehicle drivers, pick-up owners, and company vehicle drivers in Lagos must be certified by the Lagos State Drivers' Institute (LASDRI), separately from their regular driver's licence. This requirement applies in Lagos specifically, not nationwide. Drivers must be 18 or over and already hold a valid driver's licence to be trained.",
        note: "This is annual, not one-and-done — Lagos law requires professional drivers to be recertified every year, at a fixed registration fee of ₦2,000. It is also the fleet owner's problem, not just the driver's: a valid LASDRI recertification card is a prerequisite for employment by corporate organisations in Lagos, and employers using uncertified drivers can be sanctioned. Build the renewal date into whatever you use to track vehicle documents, because it expires on its own schedule.",
      },
      {
